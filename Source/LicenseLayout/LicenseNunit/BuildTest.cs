		...
		[Test] public void Test04_Gen2ParB10Byt4884() 
		{
			...
			try 
			{
				...
				for ( lopcnt = 1; lopcnt < 30; lopcnt++) 
				{
					...
					gkey.MaxTokens = 2;
					gkey.AddToken(0, "v", LicenseKeyGenerator.TokenTypes.NUMBER, "12");
					gkey.AddToken(1, "p", LicenseKeyGenerator.TokenTypes.NUMBER, "23");
					gkey.UseBase10 = true;
					gkey.UseBytes = true;
					gkey.CreateKey();
					finalkey = gkey.GetLicenseKey();
		...
		[Test] public void Test07_Gen2ParB16Bit55555() 
		{
			...
			try 
			{
				...
				for ( lopcnt = 1; lopcnt < 30; lopcnt++) 
				{
					...
					gkey.MaxTokens = 2;
					gkey.AddToken(0, "v", LicenseKeyGenerator.TokenTypes.NUMBER, "1");
					gkey.AddToken(1, "p", LicenseKeyGenerator.TokenTypes.NUMBER, "2");
					gkey.UseBase10 = false;
					gkey.UseBytes = false;
					gkey.CreateKey();
					finalkey = gkey.GetLicenseKey();
		...
		[Test] public void Test08_Gen3ParB16Bit55555() 
		{
			...
			try 
			{
				...
				for ( lopcnt = 1; lopcnt < 30; lopcnt++) 
				{
					...
					gkey.AddToken(0, "v", LicenseKeyGenerator.TokenTypes.NUMBER, "1");
					gkey.AddToken(1, "p", LicenseKeyGenerator.TokenTypes.NUMBER, "2");
					gkey.AddToken(2, "w", LicenseKeyGenerator.TokenTypes.NUMBER, "8");
					gkey.UseBase10 = false;
					gkey.UseBytes = false;
					gkey.CreateKey();
					finalkey = gkey.GetLicenseKey();
		...
		[Test] public void Test09_Gen3ParB16Byt55555() 
		{
			...
			try 
			{
				...
				for ( lopcnt = 1; lopcnt < 30; lopcnt++) 
				{
					...
					gkey.AddToken(0, "v", LicenseKeyGenerator.TokenTypes.NUMBER, "12");
					gkey.AddToken(1, "p", LicenseKeyGenerator.TokenTypes.NUMBER, "23");
					gkey.AddToken(2, "s", LicenseKeyGenerator.TokenTypes.CHARACTER, "QW");
					gkey.UseBase10 = false;
					gkey.UseBytes = true;
					gkey.CreateKey();
					finalkey = gkey.GetLicenseKey();
		...
		[Test] public void Test10_Gen3ParB16Bit55555() 
		{
			...
			try 
			{
				...
				for ( lopcnt = 1; lopcnt < 30; lopcnt++) 
				{
					...
					gkey.AddToken(0, "v", LicenseKeyGenerator.TokenTypes.NUMBER, "1");
					gkey.AddToken(1, "p", LicenseKeyGenerator.TokenTypes.NUMBER, "2");
					gkey.AddToken(2, "w", LicenseKeyGenerator.TokenTypes.CHARACTER, "QR");
					gkey.UseBase10 = false;
					gkey.UseBytes = false;
					gkey.CreateKey();
					finalkey = gkey.GetLicenseKey();
		...
		[Test] public void Test13_GenDis3ParB16Byt55555() 
		{
			...
			try 
			{
				...
				for ( lopcnt = 1; lopcnt < 30; lopcnt++) 
				{
					...
					gkey.AddToken(0, "v", LicenseKeyGenerator.TokenTypes.NUMBER, "12");
					gkey.AddToken(1, "p", LicenseKeyGenerator.TokenTypes.NUMBER, "23");
					gkey.AddToken(2, "s", LicenseKeyGenerator.TokenTypes.CHARACTER, "GH");
					gkey.UseBase10 = false;
					gkey.UseBytes = true;
					gkey.CreateKey();
					finalkey = gkey.GetLicenseKey();
		...
		[Test] public void Test14_Gen3DisParB16Bit55555() 
		{
			...
			try 
			{
				...
				for ( lopcnt = 1; lopcnt < 30; lopcnt++) 
				{
					...
					gkey.AddToken(0, "v", LicenseKeyGenerator.TokenTypes.NUMBER, "1");
					gkey.AddToken(1, "p", LicenseKeyGenerator.TokenTypes.NUMBER, "2");
					gkey.AddToken(2, "w", LicenseKeyGenerator.TokenTypes.NUMBER, "6");
					gkey.UseBase10 = false;
					gkey.UseBytes = false;
					gkey.CreateKey();
					finalkey = gkey.GetLicenseKey();
		...
		[Test] public void Test15_Gen5DisParB16Bit55555() 
		{
			...
			try 
			{
				...
				for ( lopcnt = 1; lopcnt < 30; lopcnt++) 
				{
					...
					gkey.MaxTokens = 5;
					gkey.AddToken(0, "v", LicenseKeyGenerator.TokenTypes.NUMBER, "14");
					gkey.AddToken(1, "p", LicenseKeyGenerator.TokenTypes.NUMBER, "2");
					gkey.AddToken(2, "w", LicenseKeyGenerator.TokenTypes.NUMBER, "6");
					gkey.AddToken(3, "s", LicenseKeyGenerator.TokenTypes.NUMBER, "BC");
					gkey.AddToken(4, "r", LicenseKeyGenerator.TokenTypes.NUMBER, "5");
					gkey.UseBase10 = false;
					gkey.UseBytes = false;
					gkey.CreateKey();
					finalkey = gkey.GetLicenseKey();
		...
		[Test] public void Test17_Gen5DisParB16BitChk255555() 
		{
			...
			try 
			{
				...
				for ( lopcnt = 1; lopcnt < 30; lopcnt++) 
				{
					...
					gkey.AddToken(0, "v", LicenseKeyGenerator.TokenTypes.NUMBER, "34");
					gkey.AddToken(1, "p", LicenseKeyGenerator.TokenTypes.NUMBER, "6");
					gkey.AddToken(2, "w", LicenseKeyGenerator.TokenTypes.NUMBER, "8");
					gkey.AddToken(3, "s", LicenseKeyGenerator.TokenTypes.NUMBER, "AB");
					gkey.AddToken(4, "r", LicenseKeyGenerator.TokenTypes.NUMBER, "3");
					gkey.UseBase10 = false;
					gkey.UseBytes = false;
					gkey.CreateKey();
					finalkey = gkey.GetLicenseKey();
			...
			try 
			{
				...
				while ((myInputstring = myStreamReader.ReadLine()) != null)
				{
					...
					for ( lop = 0; lop < nNumTokens; lop++) 
					{
						...
						try 
						{
							gkey.AddToken(lop, arg4, LicenseKeyGenerator.TokenTypes.NUMBER, arg5);
						}
						catch (Exception ex) 
						{
